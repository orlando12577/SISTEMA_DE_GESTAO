...
<body class="font-sans antialiased bg-[#0f172a] text-white min-h-screen flex flex-col">
    ...
    <main class="flex-1 flex items-center justify-center text-center">
        <div>
            <h1 class="text-4xl font-bold mb-4">Bem-vindo(a) ao Sistema de Gestão!</h1>
            <p class="text-lg text-gray-300">
                Use o menu acima para acessar as seções do sistema.
            </p>
        </div>
    </main>
